% Подключение к камере телефона, запись видео и выявления движения на видео. Запись нового видео с движениями

import cv2
import datetime

def webcam():
    video = cv2.VideoCapture(r"http://192.168.89.46:8080/video")
